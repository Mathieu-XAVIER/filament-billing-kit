...
use Mxavier\FilamentBillingKit\Resources\SubscriptionResource\Pages\ListSubscriptions;
use Mxavier\FilamentBillingKit\Resources\SubscriptionResource\Pages\ViewSubscription;
use UnitEnum;
            ...
            ->columns([
                ...
                TextColumn::make('stripe_status')
                    ...
                    ->color(fn (string $state): string => match ($state) {
                        ...
                        'past_due' => 'danger',
                        'canceled' => 'gray',
                        'incomplete', 'incomplete_expired' => 'danger',
                        'paused' => 'info',
                        default => 'gray',
                    })
